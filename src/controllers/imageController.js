import { findUserById, updateUserAvatar, createUserImage, getAllImages, getUserImages, getImageById, deleteImage, updateImageDetails } from "../model/userModel.js";
...
export const getFeedImages = async (req, res) => {
      try {
            ...
            const images = await getAllImages(limit, offset);
